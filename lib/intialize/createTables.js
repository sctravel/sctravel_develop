...
var createTableSQL0 = 'CREATE TABLE ' + tableNames.customerTable +
    ...
    ' provider VARCHAR(15) DEFAULT \'sctravel\' ,' +
    ...
    ' UNIQUE(customer_id), UNIQUE(username), UNIQUE(provider, email) ' +  //LOGIN and PASSWORD?
...
var createTableSQL7 = ' CREATE TABLE ' + tableNames.findPassword +
    ' ( email VARCHAR(255) NOT NULL, ' +
