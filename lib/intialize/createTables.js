...
var createTableSQL2 = ' CREATE TABLE ' + tableNames.product +
...
var createTableSQL3 = ' CREATE TABLE ' + tableNames.order +
    ' ( order_id INT PRIMARY KEY AUTO_INCREMENT, ' +
    '   order_dateTime VARCHAR(15) ,' +
	...
	'   FOREIGN KEY customers (customer_id) REFERENCES '+tableNames.customerTable+' (customer_id) ON DELETE CASCADE ' +
    '  ) ENGINE=InnoDB DEFAULT CHARSET=utf8 ';
	

	
var createTableSQL4 = ' CREATE TABLE ' + tableNames.order_detail +
